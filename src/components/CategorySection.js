    ...
    <Rosa className="container" animation="fade-down" duration={1000}>
      ...
      <div className="row m-auto">
        <div className="col-sm-4">
          <CardCategory image={imgreactjs} title="React JS" tot_speak="40" />
        </div>
        <div className="col-sm-4">
          <CardCategory image={imgangular} title="Angular" tot_speak="30" />
        </div>
        <div className="col-sm-4">
          <CardCategory image={imgnode} title="Node JS" tot_speak="25" />
        </div>
        <div className="col-sm-4">
          <CardCategory image={imgmysql} title="MySql" tot_speak="50" />
        </div>
        <div className="col-sm-4">
          <CardCategory image={imgmagento} title="Magento" tot_speak="30" />
        </div>
        <div className="col-sm-4">
          <CardCategory
